...
namespace Ramblers\Component\Ra_tools\Administrator\View\Mywalks;
...
class HtmlView extends BaseHtmlView {
    ...
    protected function addToolbar() {
        ...
        ToolbarHelper::title(Text::_('COM_RA_TOOLS_MYWALKS_PAGE_TITLE'), 'mywalks');
        ...
        if ($canDo->get('core.create')) {
            $toolbar->preferences('com_ra_tools');
        }
    }
