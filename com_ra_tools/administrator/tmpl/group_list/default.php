...
$self = 'index.php?option=com_ra_tools&view=group_list';
...
if (empty($this->items)) {
    ...
    echo '<table class="table" id="ra_groupsList">' . PHP_EOL;
    echo '<thead>' . PHP_EOL;
    echo '<tr>' . PHP_EOL;
    ...
    echo HTMLHelper::_('searchtools.sort', 'Code', 'g.code', $listDirn, $listOrder) . PHP_EOL;
    echo '</th>' . PHP_EOL;

    echo '<th scope="col" style="width:10%">' . PHP_EOL;
    echo HTMLHelper::_('searchtools.sort', 'Area', 'a.name', $listDirn, $listOrder) . PHP_EOL;
    echo '</th>' . PHP_EOL;

    echo '<th scope="col" style="width:10%">' . PHP_EOL;
    echo HTMLHelper::_('searchtools.sort', 'Name', 'g.name', $listDirn, $listOrder) . PHP_EOL;
    echo '</th>' . PHP_EOL;

    echo '<th scope="col" style="width:10%">' . PHP_EOL;
    echo HTMLHelper::_('searchtools.sort', 'Website', 'g.website', $listDirn, $listOrder) . PHP_EOL;
    echo '</th>' . PHP_EOL;

    echo '<th scope="col" style="width:20%" class="d-none d-md-table-cell">' . PHP_EOL;
    echo HTMLHelper::_('searchtools.sort', 'CO link', 'g.co_url', $listDirn, $listOrder) . PHP_EOL;
    echo '</th>' . PHP_EOL;
    ...
    foreach ($this->items as $i => $item) {
        ...
        echo '<td class="article-status">' . PHP_EOL;
        echo $item->area_name . PHP_EOL;
        echo '</td>' . PHP_EOL;

        echo '<td class="has-context">' . PHP_EOL;
        echo '<a class="hasTooltip" href="' . Route::_('index.php?option=com_ra_tools&task=group.edit&id=' . $item->id) . '">' . PHP_EOL;
