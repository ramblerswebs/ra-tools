...
/*
  ...
  echo '<form action="';
  echo Route::_('index.php?option=com_ra_tools&view=group&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id);
...
<form action="<?php echo Route::_('index.php?option=com_ra_tools&view=group&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="foo-form" class="form-validate">
    <?php
//    echo $this->getForm()->renderField('nation');
    echo $this->getForm()->renderField('code');
    echo $this->getForm()->renderField('name');
    echo $this->getForm()->renderField('details');
    echo $this->getForm()->renderField('website');
