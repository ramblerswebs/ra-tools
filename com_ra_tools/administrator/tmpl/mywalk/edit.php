...
<form action="<?php echo Route::_('index.php?option=com_ra_tools&view=mywalk&layout=edit&id=' . (int) $this->item->id); ?>"
...
<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'details')); ?>
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', Text::_('COM_RA_TOOLS_MYWALK_TAB_DETAILS')); ?>
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6">
...
<?php echo HTMLHelper::_('uitab.endTab'); ?>
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'options', Text::_('COM_RA_TOOLS_MYWALK_TAB_OPTIONS')); ?>
        <div class="row">
            <div class="col-md-12">
...
<?php echo HTMLHelper::_('uitab.endTab'); ?>
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'picture', Text::_('COM_RA_TOOLS_MYWALK_TAB_PICTURE')); ?>
        <div class="row">
            <div class="col-md-12">
